            ...
            <div className="px-4 md:flex-1">
                ...
                <div className="flex mb-4 -mx-2">
                    {isInCart?
                       ...
                       <button onClick={handleAddToCart} className="w-full px-4 py-2 font-bold text-white bg-gray-900 rounded-full hover:bg-gray-800 dark:hover:bg-gray-700">Add to Cart</button>
                   </div>: 
                   
                   
                   <div className="w-full px-2">
                       <button onClick={()=>router.push("/cart")} className="w-full px-4 py-2 font-bold text-white bg-red-600 rounded-full hover:bg-gray-800 dark:hover:bg-gray-700">View Cart</button>
                   </div>}
